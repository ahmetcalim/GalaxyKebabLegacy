...
public class MeshCut
{
    ...
    public static GameObject[] Cut(GameObject victim, Vector3 anchorPoint, Vector3 normalDirection, Material capMaterial, Transform parent)
    {
        ...
        rightSideObj.transform.SetParent(parent);
        ...
        CutController.meshFilters.Add(rightSideObj.GetComponent<MeshFilter>());
        CutController.meshFilterCount++;
        leftSideObj.GetComponent<MeshRenderer>().materials = mats;
        rightSideObj.tag = "Slicable";
        if (rightSideObj.GetComponent<MeshCollider>() == null)
        {
            rightSideObj.AddComponent<MeshCollider>();

        }
        if (rightSideObj.GetComponent<Rigidbody>() == null)
        {
            rightSideObj.AddComponent<Rigidbody>();
            rightSideObj.GetComponent<Rigidbody>().isKinematic = true;
            rightSideObj.GetComponent<Rigidbody>().useGravity = false;
        }
        if (leftSideObj.GetComponent<Rigidbody>() == null)
        {
            leftSideObj.AddComponent<Rigidbody>();
            leftSideObj.GetComponent<Rigidbody>().isKinematic = true;
            leftSideObj.GetComponent<Rigidbody>().useGravity = false;
        }
        rightSideObj.GetComponent<MeshCollider>().convex = true;
        leftSideObj.tag = "Slicable";
        if (leftSideObj.GetComponent<MeshCollider>() == null)
        {
            ...
            leftSideObj.GetComponent<MeshCollider>().convex = true;
                ...
                if (leftSideObj.GetComponent<MeshFilter>().mesh.vertexCount < rightSideObj.GetComponent<MeshFilter>().mesh.vertexCount)
                {
                    leftSideObj.GetComponent<Rigidbody>().isKinematic = false;
                    leftSideObj.GetComponent<Rigidbody>().useGravity = true;
                }
                else
                {
                    rightSideObj.GetComponent<Rigidbody>().isKinematic = false;
